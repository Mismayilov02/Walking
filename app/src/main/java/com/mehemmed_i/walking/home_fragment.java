...
//        permition_boolean =  sharedPreferences_permition.getBoolean("true"  , false);
        ...
        history_leng = sharedPreferenceManager.getInt("id" , 0);
...
//    }
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        try {
            ...
            bakcround = ContextCompat.checkSelfPermission(getActivity() , Manifest.permission.ACCESS_BACKGROUND_LOCATION);
