...
//                System.out.println(Static.tableName);

                History history = new History(location.getLongitude() , location.getLatitude());
                myroomDatabase.history_dao().insert_history(history);
